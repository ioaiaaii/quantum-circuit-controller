...
.PHONY: help
help: op-help ## Alias to repo-operator help
...
build: manifests generate fmt vet ## Build manager binary.
	go build -o dist/qcc-controller ./cmd/qcc-controller
...
build-installer: manifests generate kustomize ## Generate a consolidated YAML with CRDs and deployment.
	...
	cd config/executor && "$(KUSTOMIZE)" edit set image qcc-executor=${EXECUTOR_IMG}
...
# ---------------------------------------------------------------------------
# QCC. Everything above is kubebuilder's scaffold, kept close to stock so
# `kubebuilder alpha update` merges it cleanly. Everything below is ours.
