...
import (
	...
	"github.com/ioaiaaii/quantum-circuit-controller/test/utils"
)

// namespace where the project is deployed in
const namespace = "quantum-circuit-controller-system"

// serviceAccountName created for the project
const serviceAccountName = "quantum-circuit-controller-controller-manager"

// metricsServiceName is the name of the metrics service of the project
const metricsServiceName = "quantum-circuit-controller-controller-manager-metrics-service"

// metricsRoleBindingName is the name of the RBAC that will be created to allow get the metrics data
const metricsRoleBindingName = "quantum-circuit-controller-metrics-binding"
...
var _ = Describe("Manager", Ordered, func() {
	...
	BeforeAll(func() {
		...
		cmd = exec.Command("make", "deploy",
			...
			fmt.Sprintf("EXECUTOR_IMG=%s", executorImage))
		_, err = utils.Run(cmd)
	...
	Context("Manager", Label("smoke"), func() {
		...
		It("should ensure the metrics endpoint is serving metrics", func() {
			...
			cmd := exec.Command("kubectl", "create", "clusterrolebinding", metricsRoleBindingName,
				"--clusterrole=quantum-circuit-controller-metrics-reader",
