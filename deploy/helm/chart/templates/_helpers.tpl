...
*/}}
{{- define "quantum-circuit-controller.name" -}}
...
*/}}
{{- define "quantum-circuit-controller.fullname" -}}
...
*/}}
{{- define "quantum-circuit-controller.namespaceName" -}}
{{- .Release.Namespace }}
{{- end }}
...
*/}}
{{- define "quantum-circuit-controller.resourceName" -}}
{{- $fullname := include "quantum-circuit-controller.fullname" .context }}
{{- $suffix := .suffix }}
...
*/}}
{{- define "quantum-circuit-controller.serviceAccountName" -}}
{{- if and (not (.Values.serviceAccount.enabled | default true)) .Values.serviceAccount.name }}
{{- .Values.serviceAccount.name }}
{{- else }}
{{- include "quantum-circuit-controller.resourceName" (dict "suffix" "controller-manager" "context" .) }}
{{- end }}
{{- end }}
